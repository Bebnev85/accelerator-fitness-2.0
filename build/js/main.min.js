...
var getElementDataAttr = function getElementDataAttr(value) {
  return document.querySelector('div[data-block="' + value + '"]');
};
...
},{"./modules/form-validate/form":3,"./modules/init-bg-image":9,"./modules/modals/init-modals":10,"./modules/sliders":12,"./utils/acordion/init-accordion":14,"./utils/ios-vh-fix":17,"./utils/tabs/init-tabs":19}],2:[function(require,module,exports){
"use strict";
