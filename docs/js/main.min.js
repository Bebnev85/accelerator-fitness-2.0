...
var _initTabs = require("./utils/tabs/init-tabs");
var _initAccordion = require("./utils/acordion/init-accordion");
var _initBgImage = require("./modules/init-bg-image");
var _load_video = require("./modules/load_video");
// ---------------------------------
...
window.addEventListener('DOMContentLoaded', function () {
  ...
  window.addEventListener('load', function () {
    (0, _initBgImage.initImgBg)();
    (0, _initTabs.initTabs)();
    (0, _initModals.initModals)();
    (0, _load_video.initVideo)();
    (0, _sliders.sliderCoachInit)();
    (0, _sliders.sliderReviewsInit)();
...
},{"./modules/form-validate/form":3,"./modules/init-bg-image":9,"./modules/load_video":10,"./modules/modals/init-modals":11,"./modules/sliders":13,"./utils/acordion/init-accordion":15,"./utils/ios-vh-fix":18,"./utils/tabs/init-tabs":20}],2:[function(require,module,exports){
"use strict";
...
exports.initImgBg = void 0;
var initImgBg = function initImgBg() {
  var elements = document.querySelectorAll('[data-bgdesctop]');
...
var initVideo = function initVideo() {
  var button = document.querySelector('.main-section__gim-video-conatainer').querySelector('button');
...
exports.sliderReviewsInit = exports.sliderCoachInit = void 0;
var _swiper = _interopRequireDefault(require("../vendor/swiper"));
function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }
var sliderCoachInit = function sliderCoachInit() {
  var SWIPER = new _swiper.default('.coach-swiper__container', {
    navigation: {
...
exports.sliderCoachInit = sliderCoachInit;
var sliderReviewsInit = function sliderReviewsInit() {
  var SWIPER = new _swiper.default('.reviews-swiper__container', {
    navigation: {
...
exports.sliderReviewsInit = sliderReviewsInit;
...
},{"./accordions":14}],16:[function(require,module,exports){
"use strict";
